            ...
            <div className="flex flex-col md:flex-row lg:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="relative">
                  <input
                    type="text"
                    placeholder={isProvider ? "Search Providers...." : "Search Users...."}
                ...
                {/* Filter Button */}
                {isProvider &&<button className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" onClick={() => filters.setShowFilter(!filters.showFilter)}>
          ...
          {isLoading ? (
            ...
            <>
              <div className="overflow-x-auto">
                <table className={`${isProvider ? 'min-w-full' : 'w-full'} divide-y divide-gray-200`}>
                  <thead>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {pagination.currentItems.map((provider: any, index) => (
                      <tr
                        key={provider?._id}
                      ...
                      >
                        ...
                        {isProvider && <td className="px-8 py-4 whitespace-nowrap">
